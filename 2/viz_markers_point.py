...
# python viz_markers_point.py --csv ./train-1500.csv --out ./porto_markers.html
#
# 想要 Toner 风格（有 attribution，服务不稳定）：
# python viz_markers_point.py --csv ./train-1500.csv --out ./porto_markers.html --stamen
#
# 不画轨迹折线（只看图钉）：
# python viz_markers_point.py --csv ./train-1500.csv --out ./porto_markers.html --no-lines
